...
A position becomes liquidatable when its payout is less than or equal to 5\% of its gross value. However, to prevent manipulation-based liquidations, Whiplash employs an \textbf{EMA Price Oracle} that blocks liquidations when rapid price movements are detected.
